...
In addition, please also cite the original works of any *relevant* methods and algorithms that your use relies on, like multislice, mixed-state formalism, tilted propagator; see {doc}`bibliography`.